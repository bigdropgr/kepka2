...
class ELearning_Lesson_Widget extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
            ...
            'E-Learning Τροφοδοσία Μαθημάτων',
            [
                'description' => 'Εμφάνιση τροφοδοσίας μαθημάτων',
    ...
    public function widget($args, $instance) {
        $title = !empty($instance['title']) ? $instance['title'] : 'Πρόσφατα Μαθήματα';
                        ...
                        <div class="widget-lesson-content">
                            ...
                            <?php if ($show_progress): ?>
                                <div class="widget-lesson-progress">
                                    ...
                                    <span class="progress-text"><?php echo $progress; ?>% ολοκληρωμένο</span>
                                </div>
                            <?php endif; ?>
                        </div>
                    </li>
    ...
    public function form($instance) {
        ...
        <p>
            <label for="<?php echo $this->get_field_id('number'); ?>">Αριθμός μαθημάτων για εμφάνιση:</label>
