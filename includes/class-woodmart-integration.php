...
class ELearning_WoodMart_Integration {
    ...
    public function generateDynamicCSS(): string {
        ...
        .elearning-lesson-container {
            font-family: <?php echo esc_attr($settings['text_font_family']); ?>, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif;
        ...
        .elearning-quiz-container,
        .elearning-lesson-container,
        .elearning-widget-lessons,
        .elearning-widget-quizzes {
            font-family: <?php echo esc_attr($settings['text_font_family']); ?>, "Noto Sans", -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif;
        }
        ...
        .question-title,
        .section-title {
            font-family: <?php echo esc_attr($settings['title_font_family']); ?>, "Noto Sans", -apple-system, BlinkMacSystemFont, sans-serif;
        ...
        .loan-calculator button {
            ...
            font-family: <?php echo esc_attr($settings['text_font_family']); ?>, "Noto Sans", -apple-system, BlinkMacSystemFont, sans-serif;
        ...
        /* Ensure Greek characters display properly */
        html[lang="el"] .elearning-quiz-container,
        html[lang="el"] .elearning-lesson-container,
        html[lang="el"] .loan-calculator {
            font-family: <?php echo esc_attr($settings['text_font_family']); ?>, "Noto Sans", "Helvetica Neue", Helvetica, Arial, sans-serif;
        }
    ...
    private function hasELearningShortcode(): bool {
        ...
        $shortcodes = ['loan_calculator', 'display_lesson', 'display_quiz', 'quiz_stats', 'user_progress', 'lesson_feed', 'quiz_feed'];
