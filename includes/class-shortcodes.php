 ...
 * Greek only version - language options removed
 */
...
class ELearning_Shortcodes {
        ...
        if ($has_shortcode) {
            ...
            wp_localize_script('elearning-shortcodes', 'elearningShortcodes', [
                ...
                'strings' => [
                    ...
                    'monthly_payment' => 'Μηνιαία Δόση',
                    'total_payment' => 'Συνολική Πληρωμή',
                    'total_interest' => 'Συνολικός Τόκος',
                    'error_invalid_input' => 'Παρακαλώ εισάγετε έγκυρους αριθμούς',
                    'error_negative_values' => 'Οι τιμές δεν μπορούν να είναι αρνητικές',
                    'loading' => 'Φόρτωση...'
                ]
            ]);
        }
                ...
                <div class="lesson-card-content">
                    ...
                    <?php if ($atts['show_sections_count'] === 'true'): ?>
                        <div class="lesson-meta">
                            <span class="sections-count">
                                ...
                                <?php echo sprintf('%d ενότητες', count($sections)); ?>
                            </span>
                        </div>
                    <?php endif; ?>
                    ...
                    <?php if ($atts['show_progress'] === 'true'): ?>
                        <div class="lesson-progress-bar">
                            ...
                            <span class="progress-text"><?php echo sprintf('%d%% ολοκληρώθηκε', $progress_percentage); ?></span>
                        </div>
                    <?php endif; ?>
                    ...
                    <div class="quiz-meta">
                        <?php if ($atts['show_questions_count'] === 'true'): ?>
                            <span class="questions-count">
                                ...
                                <?php echo sprintf('%d ερωτήσεις', count($questions)); ?>
                            </span>
                        <?php endif; ?>
                        ...
                        <?php if ($atts['show_passing_score'] === 'true'): ?>
                            <span class="passing-score">
                                ...
                                <?php echo sprintf('%d%% για επιτυχία', $passing_score); ?>
                            </span>
                        <?php endif; ?>
                        ...
                        <?php if ($time_limit > 0): ?>
                            <span class="time-limit">
                                ...
                                <?php echo sprintf('%d λεπτά', $time_limit); ?>
                            </span>
                        <?php endif; ?>
                    </div>
                    ...
                    <?php if ($atts['show_stats'] === 'true' && $attempt_count > 0): ?>
                        <div class="quiz-user-stats">
                            <span class="attempts">
                                ...
                                <?php echo sprintf('%d προσπάθειες', $attempt_count); ?>
                            </span>
                            <span class="best-score">
                                <i class="fas fa-star"></i>
                                <?php echo sprintf('Καλύτερη: %d%%', $best_score); ?>
                            </span>
                        </div>
                    <?php endif; ?>
    ...
    public function loanCalculator($atts): string {
        ...
        <div class="loan-calculator-container <?php echo esc_attr($theme_class); ?>" id="<?php echo esc_attr($calculator_id); ?>">
            <div class="loan-calculator">
                ...
                <div class="loan-results" style="display: none;">
                    <h4>Αποτελέσματα Υπολογισμού</h4>
                    
                    <div class="results-grid">
                        <div class="result-item highlight">
                            <span class="result-label">Μηνιαία Δόση</span>
                            <span class="result-value monthly-payment">-</span>
                        </div>
                        
                        <div class="result-item">
                            <span class="result-label">Συνολική Πληρωμή</span>
                            <span class="result-value total-payment">-</span>
                        </div>
                        
                        <div class="result-item">
                            <span class="result-label">Συνολικός Τόκος</span>
                            <span class="result-value total-interest">-</span>
                        </div>
                        
                        <div class="result-item">
                            <span class="result-label">Επιτόκιο</span>
                                ...
                                <div class="chart-container">
                                    ...
                                    <div class="chart-legend">
                                        <div class="legend-item">
                                            ...
                                            <span class="legend-text">Κεφάλαιο</span>
                                        </div>
                                        <div class="legend-item">
                                            <span class="legend-color interest"></span>
                                            <span class="legend-text">Τόκος</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        function calculateLoan(calculatorId) {
            ...
            if (isNaN(loanAmount) || isNaN(interestRate) || isNaN(loanTerm)) {
                showError(errorDiv, 'Παρακαλώ εισάγετε έγκυρους αριθμούς');
                return;
            }
            
            if (loanAmount <= 0 || interestRate < 0 || loanTerm <= 0) {
                showError(errorDiv, 'Παρακαλώ εισάγετε θετικές τιμές');
                return;
            }
            ...
            setTimeout(() => {
                try {
                    ...
                    showError(errorDiv, 'Παρουσιάστηκε σφάλμα υπολογισμού');
                }
        ...
        function toggleBreakdown(calculatorId) {
            ...
            if (breakdown.style.display === 'none') {
                ...
                button.textContent = 'Απόκρυψη Ανάλυσης Πληρωμών';
            } else {
                breakdown.style.display = 'none';
                button.textContent = 'Εμφάνιση Ανάλυσης Πληρωμών';
            }
        }
        </script>
        <?php
            ...
            <?php if (!$can_access && $associated_lesson): ?>
                <div class="quiz-access-notice">
                    <p class="access-requirement">
                        ...
                        if ($lesson) {
                            echo sprintf(
                                'Πρέπει να ολοκληρώσετε το %s πριν δώσετε αυτό το κουίζ.',
                                '<strong>' . esc_html($lesson->post_title) . '</strong>'
                            );
                        }
                        ?>
                    ...
                    <?php if ($lesson_progress > 0): ?>
                        <div class="progress-preview">
                            ...
                            <span class="progress-text"><?php echo sprintf('%d%% ολοκληρώθηκε', $lesson_progress); ?></span>
                        </div>
                    <?php endif; ?>
                </div>
            <?php endif; ?>
        ...
        <div class="quiz-statistics" data-quiz-id="<?php echo esc_attr($quiz_id); ?>">
            ...
            <div class="stats-grid">
                ...
                <div class="stat-item">
                    ...
                    <span class="stat-label">Επιτυχημένες</span>
                </div>
    ...
    private function getQuizStatsSummary($quiz_id): string {
        ...
        return sprintf(
            '<div class="stats-mini"><span>%d προσπάθειες</span> <span>%.1f%% επιτυχία</span> <span>%.1f%% μ.ο.</span></div>',
