...
class ELearning_Quiz_Widget extends WP_Widget {
    ...
    public function widget($args, $instance) {
        $title = !empty($instance['title']) ? $instance['title'] : 'Πρόσφατα Κουίζ';
                        ...
                        <div class="widget-quiz-content">
                            ...
                            <?php if ($show_stats): ?>
                                <div class="widget-quiz-meta">
                                    ...
                                    <?php if ($has_passed): ?>
                                        <span class="status passed">Επιτυχία</span>
                                    <?php endif; ?>
                                </div>
                            <?php endif; ?>
                        </div>
    ...
    public function form($instance) {
        ...
        <p>
            <label for="<?php echo $this->get_field_id('number'); ?>">Αριθμός κουίζ για εμφάνιση:</label>
