            ...
            <tr>
                ...
                <td>
                    <input type="number" 
                           ...
                           max="100" 
                           step="1" />
                    <p class="description">Ελάχιστο ποσοστό που απαιτείται για να περάσει το κουίζ.</p>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input type="number" 
                           ...
                           min="1" 
                           step="1" />
                    <p class="description">Αριθμός ερωτήσεων για εμφάνιση από την τράπεζα ερωτήσεων. Αφήστε κενό για εμφάνιση όλων.</p>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input type="number" 
                           ...
                           min="0" 
                           step="1" />
                    <p class="description">Χρονικό όριο σε λεπτά. Ορίστε σε 0 για κανένα χρονικό όριο.</p>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <select name="show_results_immediately" id="show_results_immediately">
                        <option value="yes" <?php selected($show_results, 'yes'); ?>>Ναι - Εμφάνιση σωστών απαντήσεων μετά την υποβολή</option>
                        <option value="no" <?php selected($show_results, 'no'); ?>>Όχι - Εμφάνιση μόνο βαθμολογίας</option>
                    </select>
                </td>
            </tr>
            <tr>
