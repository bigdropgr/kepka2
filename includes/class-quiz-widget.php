...
class ELearning_Quiz_Widget extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
            'elearning_quiz_feed',
            'E-Learning Τροφοδοσία Κουίζ',
            [
                'description' => 'Εμφάνιση τροφοδοσίας κουίζ',
    ...
    public function widget($args, $instance) {
        $title = !empty($instance['title']) ? $instance['title'] : 'Τελευταία Κουίζ';
                        ...
                        <div class="widget-quiz-content">
                            ...
                            <?php if ($show_stats): ?>
                                <div class="widget-quiz-meta">
                                    <span class="questions"><?php echo count($questions); ?> ερωτήσεις</span>
                                    <?php if ($has_passed): ?>
                                        <span class="status passed">Επιτυχής</span>
                                    <?php endif; ?>
                                </div>
                            <?php endif; ?>
                        </div>
    ...
    public function form($instance) {
        ...
        <p>
            <label for="<?php echo $this->get_field_id('title'); ?>">Τίτλος:</label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('number'); ?>">Αριθμός κουίζ προς εμφάνιση:</label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('category'); ?>">Κατηγορία:</label>
